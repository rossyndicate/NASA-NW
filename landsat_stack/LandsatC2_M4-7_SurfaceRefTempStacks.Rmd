...
def RefPull457(image):
  ...
  d1 = d.eq(1).rename('dswe1').selfMask().updateMask(f.eq(0)).updateMask(s.eq(0)).updateMask(r.eq(1))
  #calculate hillshade
  ...
  dswe3 = d.eq(3).rename('dswe3').selfMask().updateMask(f.eq(0)).updateMask(s.eq(0)).updateMask(r.eq(1))
