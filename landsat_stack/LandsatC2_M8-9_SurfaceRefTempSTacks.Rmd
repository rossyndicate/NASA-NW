...
def RefPull89(image):
  ...
  # where the f mask is >= 1 (clouds,cloud shadow, snow), call that 1 (otherwise 0) and rename as clouds.
  ...
  .combine(ee.Reducer.count().unweighted().forEachBand(pixOut.select(['Aerosol','Blue', 'Green', 'Red', 'Nir', 'Swir1', 'Swir2','SurfaceTemp', 'dswe1', 'dswe3', 'clouds'])), outputPrefix = 'pCount_', sharedInputs = False)
